                        ...
                        <div class="user">
                            ...
                            <div class="content">
                                <h6 class="title">
                                    ...
                                    <p class="mt-2">1 {{ __($general->cur_text) }} =
                                        {{ showAmount($general->usd_rate, 2) }} @lang('USD')</p>
                                </h6>
                            </div>
                        </div>
                        <div class="main-menu">
                            <ul>
                                ...
                                <li>
                                    <a href="{{ route('user.wallet') }}"><i
                                            class="las la-wallet"></i>@lang('Wallet')</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="{{ route('user.trx.history') }}"><i
                                ...
                                <li>
                                    <a href="{{ route('ticket') }}"><i
                                            class="las la-ticket-alt"></i>@lang('Support Ticket')</a>
                                </li>
                                <li>
