    ...
    <div class="col-xl-9">
        <div class="profile-area">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <form class="user-profile-form row mb--20 prevent-double-click" action="" method="post"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="col-md-6 mb-20">
                            <label for="firstname" class="form--label">@lang('First Name')</label>
                            <input class="form-control form--control" id="firstname" type="text" name="firstname"
                                value="{{ $user->firstname }}" minlength="3" required>
                        </div>
                        <div class="col-md-6 mb-20">
                            <label for="lastname" class="form--label">@lang('Last Name')</label>
                            <input class="form-control form--control" id="lastname" type="text" name="lastname"
                                value="{{ $user->lastname }}" required>
                        </div>
                        <div class="col-md-6 mb-20">
                            <label for="email" class="form--label">@lang('Email Address')</label>
                            <input class="form-control form--control" id="email" name="email" type="text"
                                value="{{ $user->email }}" readonly>
                        </div>
                        <div class="col-md-6 mb-20">
                            <label for="phone" class="form--label">@lang('Mobile')</label>
                            <input class="form-control form--control" id="phone" name="phone" type="text"
                                value="{{ $user->mobile }}" readonly>
                        </div>
                        <div class="col-md-6 mb-20">
                            <label for="address" class="form--label">@lang('Address')</label>
                            <input class="form-control form--control" id="address" name="address" type="text"
                                value="{{ @$user->address->address }}" required="">
                        </div>
                        <div class="col-md-6 mb-20">
                            <label for="state" class="form--label">@lang('State')</label>
                            <input class="form-control form--control" id="state" name="state" type="text"
                                value="{{ @$user->address->state }}" required="">
                        </div>
                        <div class="col-md-6 mb-20">
                            <label for="zip" class="form--label">@lang('Zip Code')</label>
                            <input class="form-control form--control" id="zip" name="zip" type="text"
                        ...
                        <div class="col-md-6 mb-20">
                            ...
                            <input class="form-control form--control" id="country" name="country" type="text"
                                value="{{ @$user->address->country }}" readonly>
                        </div>
                        <div class="col-md-6 mb-20">
                            <label for="image" class="form--label">@lang('Change Image')</label>
                            <input type="file" name="image" accept="image/*" class="form-control form--control"
                                id="image">
                        </div>
