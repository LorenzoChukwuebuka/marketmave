...
Route::namespace('Admin')->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        Route::post('add-wallet', 'ApiController@addWalletAddress')->name('wallet.add');
        Route::get('edit-wallet/{id}', 'ApiController@editWallet')->name('wallet.edit');
        Route::post('update-wallet/{id}', 'ApiController@updateWallet')->name('wallet.update');
        Route::delete('delete-wallet/{id}', 'ApiController@deleteWallet')->name('wallet.delete');
        ...
        Route::get('payments/details/{id}', 'AdminController@getPaymentDetails')->name('payments.details');
        Route::post('payments/confirm/{id}', 'AdminController@confirmPayment')->name('payments.confirm');
...
Route::name('user.')->group(function () {
    ...
    Route::post('/resendmail', 'Auth\RegisterController@resendMail')->name('emailresend');
